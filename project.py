...
character = Surface((18,16),pygame.SRCALPHA)
character.blit(spritesheet,(-47,-172))
...
character = Surface((18,16),pygame.SRCALPHA)
character.blit(spritesheet,(-66,-172))
character = pygame.transform.scale(character, (16*4,16*4))
stage = Surface((300,150),pygame.SRCALPHA)
stage.blit(character,(130,30))
goombaright = stage
...
character.blit(spritesheet,(-88,-26))
...
character = Surface((16,16),pygame.SRCALPHA)
character.blit(spritesheet,(-109,-26))
character = pygame.transform.scale(character, (16*4,16*4))
stage = Surface((300,16*4),pygame.SRCALPHA)
stage.blit(character,(130,0))
toasterwalk2 = stage
...
character = Surface((34,60),pygame.SRCALPHA)
character.blit(spritesheet,(0,-211))
character = pygame.transform.scale(character, (26*4,28*4))
stage = Surface((300,16*4),pygame.SRCALPHA)
stage.blit(character,(130,0))
toasterwalk11 = stage
...
character = Surface((34,60),pygame.SRCALPHA)
character.blit(spritesheet,(-40,-211))
character = pygame.transform.scale(character, (26*4,28*4))
stage = Surface((300,16*4),pygame.SRCALPHA)
stage.blit(character,(130,0))
toasterwalk22 = stage

toasterwalkloop1 = [toasterwalk11,toasterwalk22]
...
character = Surface((14,16),pygame.SRCALPHA)
character.blit(spritesheet,(-46,-68))
character = pygame.transform.scale(character, (14*4,16*4))
stage = Surface((300,16*4),pygame.SRCALPHA)
stage.blit(character,(130,0))
toasterwalk13 = stage
...
character = Surface((16,16),pygame.SRCALPHA)
character.blit(spritesheet,(-67,-68))
character = pygame.transform.scale(character, (16*4,16*4))
stage = Surface((300,16*4),pygame.SRCALPHA)
stage.blit(character,(130,0))
toasterwalk23 = stage

toasterwalkloop2 = [toasterwalk13,toasterwalk23]
...
class Rooms(object):
    ...
    def createroom1(self, entrance):
        ...
        self.game.enemygroup.add(Goomba(748, 1109, -2))
        self.game.enemygroup.add(Goomba(1405, 1109, -2))
        self.game.enemygroup.add(Goomba(300, 1109, -2))
        self.game.enemygroup.add(Goomba(140, 1109, -2))
    ...
    def createroom2(self, entrance):
        ...
        if entrance == "a": self.player.startingposition(0,476)

        
        self.game.platforms.append(Platform(0,188,48,72))
        self.game.platforms.append(Platform(48,188,48,56))
        self.game.platforms.append(Platform(96,188,64,40))
        self.game.platforms.append(Platform(160,188,48,56))
        self.game.platforms.append(Platform(208,188,48,72))
        #self.game.platforms.append(Platform(224,88,32,64))
        self.game.platforms.append(Platform(274,0,1,224))
        ...
        self.game.enemygroup.add(Toaster1(360, 496, 600, 2))

        
        self.game.exitgroup.add(RoomExit(self,-32,108,32,64,3,"b"))
    ...
    def createroom4(self,entrance):
        ...
        if entrance == "a": self.player.startingposition(1072,598)

        
 
        self.game.platforms.append(Platform(400,200,160,40))
        self.game.platforms.append(Platform(0,230,200,208))
        self.game.platforms.append(Platform(48,0,160,24)) 
        self.game.platforms.append(Platform(208,0,48,56))
        self.game.platforms.append(Platform(208,230,198,40))
        self.game.platforms.append(Platform(256,230,32,16))

        self.game.enemygroup.add(Toaster2(400, 618, 600, 2))
 
        self.game.exitgroup.add(RoomExit(self,-100,230,132,80,3,"c"))
    ...
    def createroom5(self, entrance):
        ...
        if entrance == "c": self.player.startingposition(0,366)
...
class Toaster1(Entity):
    ...
    def animate(self):
        if self.destroyed == True:
            ...
            self.walkloop(toasterwalkloop1)
...
class Toaster2(Entity):
    ...
    def animate(self):
        if self.destroyed == True:
            ...
            self.walkloop(toasterwalkloop2)
...
class Title(object):
    ...
    def update(self):
        ...
        if self.counter == 100:
            ss = Entity()
            font = pygame.font.Font(None, 80)
            ss.image = font.render("Starting", 1, (255, 255, 255))
        ...
        if self.counter == 500:
            ...
            ss = Entity()
            font = pygame.font.Font(None, 80)
            ss.image = font.render("Press Space To Start", 1, (255, 255, 255))
            ss.rect = Rect(140,400,100,100)
            self.game.menugroup.add(ss)
        self.counter = self.counter + 1
